...
require_once STANBOL_ENHANCER_PATH."/StanbolEngineOptions.php";
...
class StanbolEngine extends SemanticEngine {
     ...
     * @param $articleID
     */
    public function storeAnnotations(array $entityIDs, $articleID)
    {
        $data = array();
        $data["entityIDs"] = $entityIDs;
        $data["articleID"] = $articleID;
        parent::runModule("storeModule","store",$data);
    }
